...
if (isset($_REQUEST['submit']) and $_REQUEST['submit'] != '') {
	$target_file = "foto_leader/" . basename($_FILES["foto"]["name"]);
    ...
    if ($project_name == '') {
        ...
        $insert = $db->insert('project', $data);
        if ($insert) {
            header('location:project.php?msg=ras');
            exit();
        } else {
...
<head>
	...
	<title>Tambah Project | Project Monitoring</title>
...
<body>
    ...
    echo '<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Data gagal ditambahkan <strong>Coba ulang!</strong></div>';
		...
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Tambah Project</strong> <a
			...
			<div class="card-body">
				...
				<div class="form-group">
					...
					<input type="email" name="email" id="email" class="form-control" placeholder="Masukkan email leader"
						required>
				</div>
				<div class="form-group">
					<label for="foto">Foto </label>
					<input type="file" name="foto" id="foto" class="form-control" placeholder="Masukkan foto leader">
				</div>
				<div class="form-group">
					<label>Progress <span class="text-danger">*</span></label>
					<input type="number" class="form-control" name="progress" id="progress"
						placeholder="Masukkan persentase progress" required>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i
							class="fa fa-fw fa-plus-circle"></i> Tambah Project</button>
				</div>
				</form>
			</div>
		</div>
